    ...
    */
    public class StringCalculator
    {
        /*
            ...
            If the given String instance is Null, throws an ArgumentException. If not, makes a call to the helper method, 
            AddStringContents(), passing in the provided String instance and the delimiter(s) seperating the numbers inside 
            the provided String. Default delimietrs are: "," and "\n" but the user can choose their own custom delimiters. 
        */
