...
namespace String_Calculator_Kata.Classes
{
    /*
        ...
        required to manipulate the String instance a user provides in a number of different ways required by some of the StringCalculator methods.

        Due to the complexity of these operations (checking for delimietrs and extracting any custom delimiters), it made sense to create 
        an extension class with these operations encapsulated inside extension methods that can be easily invoked from any string instance.
    */
